...
import com.irfane.produits.repos.ProduitRepository;
...
class ProduitsApplicationTests {
	...
	Produit prod = new Produit("PC HP",100.500,new Date());
	Produit prod2 = new Produit("PS 4 ",102.00,new Date());
	...
	{
		List<Produit> prods = produitRepository.findByNomPrix("PC HP", 100.0);
		for (Produit p : prods)
		{
			System.out.println(p);
		}
